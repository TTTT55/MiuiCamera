...
.method static constructor <clinit>()V
    ...
    const-string v2, "WHITEN_STRENGTH"

    invoke-direct {v0, v2, v1}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v3, "SHRINK_FACE_RATIO"

    invoke-direct {v0, v3, v2}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v4, "ENLARGE_EYE_RATIO"

    invoke-direct {v0, v4, v3}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "SMOOTH_STRENGTH"

    invoke-direct {v0, v5, v4}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v6, "NOSE_RATIO"

    invoke-direct {v0, v6, v5}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v7, "RISORIUS_RATIO"

    invoke-direct {v0, v7, v6}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v8, "LIPS_RATIO"

    invoke-direct {v0, v8, v7}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v9, "CHIN_RATIO"

    invoke-direct {v0, v9, v8}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v10, "NECK_RATIO"

    invoke-direct {v0, v10, v9}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v11, "SMILE_RATIO"

    invoke-direct {v0, v11, v10}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v12, "SLIM_NOSE_RATIO"

    invoke-direct {v0, v12, v11}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v13, "EYEBROW_DYE_RATIO"

    invoke-direct {v0, v13, v12}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v14, "PUPIL_LINE_RATIO"

    invoke-direct {v0, v14, v13}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v15, "JELLY_LIPS_RATIO"

    invoke-direct {v0, v15, v14}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v14, "BLUSHER_RATIO"

    invoke-direct {v0, v14, v15}, Lcom/android/camera/effect/BeautyParameters$Type;-><init>(Ljava/lang/String;I)V
    ...
    .line 28
    sget-object v14, Lcom/android/camera/effect/BeautyParameters$Type;->WHITEN_STRENGTH:Lcom/android/camera/effect/BeautyParameters$Type;
...
.method public static values()[Lcom/android/camera/effect/BeautyParameters$Type;
    ...
    invoke-virtual {v0}, [Lcom/android/camera/effect/BeautyParameters$Type;->clone()Ljava/lang/Object;
